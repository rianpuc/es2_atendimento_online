...
- **DEV 1 - Gustavo:** Gerenciamento do Profissional de Saúde (ProfissionalSaudeController + ProfissionalSaudeList/Form)
- **DEV 2 - Rian:** Gerenciamento de Atendimentos Integrados (AtendimentoController + AtendimentoList/Form)
- **DEV 3 - Rafael:** Gerenciamento de Exames de Laboratório vinculados aos atendimentos (ExameLaboratorioController + ExameList/Form)
